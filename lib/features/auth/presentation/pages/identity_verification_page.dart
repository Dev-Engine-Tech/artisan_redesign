      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
                'Provide a government issued ID and a clear selfie to verify your identity.',
              ...
              child: Column(
                children: [
                  ...
                  Align(
                      ...
                      child: const Text('Issued Country',
                          style: TextStyle(color: Colors.black54))),
                  const SizedBox(height: 8),
                      ...
                      onPressed: () async {
                        ...
                        if (mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content:
                                      Text('Document uploaded (simulated)')));
                        }
                      },
                            ...
                            child: ElevatedButton(
                              onPressed: state.submitting
                                  ...
                                  : () async {
                                      ...
                                      await context.read<VerificationCubit>().finalizeVerification();
                                      if (!mounted) return;
                                      try {
