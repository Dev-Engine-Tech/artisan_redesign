...
class ApiEndpoints {
  ...
  static String catalogRequestDetail(int requestId) =>
      '$catalog/api/catalog/request/details/$requestId/';
  static String catalogRequestMaterials(int requestId) =>
      '$catalog/api/catalog/request/$requestId/materials/';
  static String catalogRequestAgreement(int requestId) =>
